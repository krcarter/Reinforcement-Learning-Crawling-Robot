...
void loop() {
  ...
  if (currentMillis - previousMillis >= updateInterval) {
    ...
    int J4 = map(row_5[currentPosition], 0, 180, SERVOMIN, SERVOMAX);
    int J5 = map(row_6[currentPosition], 0, 180, SERVOMIN, SERVOMAX);
    int J6 = map(row_7[currentPosition], 0, 180, SERVOMIN, SERVOMAX);
    int J7 = map(row_8[currentPosition], 0, 180, SERVOMIN, SERVOMAX);
