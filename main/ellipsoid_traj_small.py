...
def sim_to_real_text_file(trajectory, num_steps):
    ...
    #np.savetxt('manual_walk_short.csv', rounded_trajectory, delimiter=',')
    ...
    with open('arduino_arrays_short.txt', 'w') as file:
...
urdf_path = "urdf/small_robot/crawly.urdf"  # Change this to your URDF file path
